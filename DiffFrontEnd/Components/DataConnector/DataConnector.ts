...
export class DataConnector {
    ...
    public async GetEntityDetailsForConnectionStrings(model: SolutionDetailsForConnectionStringRequest): Promise<SolutionDetailsForConnectionString[]> {
        try {
            const result = await BaseApiConnector.Post<SolutionDetailsForConnectionString[]>(this._signal, "Data", "GetEntityDetailsForConnectionStrings", model);
            if (result) {
                return result;
            }
        } catch (error) {
    ...
    public async GetEntityDetails(model: SolutionsDetailsRequest): Promise<ElementDetailsForSolution[]> {
        try {
            const result = await BaseApiConnector.Post<ElementDetailsForSolution[]>(this._signal, "Data", "GetEntityDetailsBySolution", model);
            if (result) {
                return result;
            }
        } catch (error) {
