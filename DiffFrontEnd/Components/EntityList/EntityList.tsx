...
import { getClassNames } from "./EntityList.classNames";
...
export interface EntityListProp {
...
export class SolutionList extends React.Component<EntityListProp, EntityListState> {
    ...
    constructor(prop: EntityListProp) {
        super(prop);
        this.state = {
            rows: [],
            isLoading: false,
    ...
    render() {
        ...
        return (
            <Stack tokens={{ childrenGap: 20 }}>
                ...
                {selectedToPass && <SolutionDetail {...{ Name: selectedToPass, OnlySolutionComponent: false, ...this.props }} />}
            </Stack>
        );
    }
    ...
    componentDidUpdate(prevProps: EntityListProp) {
    ...
    handleExport(_ev: any) {
        ...
        const fileName = "CompareEnvironmentsEntities" + new Date().toLocaleString().split(' ').join('_');
        const sheetProps = {
            Title: "Compare Environments Entities",
            Subject: "Solutions",
