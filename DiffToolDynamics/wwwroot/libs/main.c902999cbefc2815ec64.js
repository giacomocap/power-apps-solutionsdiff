...
class BaseApiConnector {
    ...
    static async Post(_signal, controller, method, data) {
        try {
            ...
            return (await axios__WEBPACK_IMPORTED_MODULE_0___default().post(url, data)).data;
        }
        catch (ex) {
            throw ex;
        }
...
/* harmony export */ });
/* harmony import */ var _Helper_LocalStorageHelper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../Helper/LocalStorageHelper */ "./Helper/LocalStorageHelper.ts");
/* harmony import */ var _Helper_Model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../Helper/Model */ "./Helper/Model.ts");
...
class ConnectionStringLSConnector {
    GetAll() {
        return _Helper_LocalStorageHelper__WEBPACK_IMPORTED_MODULE_0__.LSHelper.getWithExpiry(LSCONNECTIONS_KEY);
    }
    AddOrUpdate(model) {
        let exisitng = this.GetAll();
        if (!exisitng)
            exisitng = [];
        if (model.Id && model.Id !== _Helper_Model__WEBPACK_IMPORTED_MODULE_1__.Guid.Empty) {
            ...
            model.Id = _Helper_Model__WEBPACK_IMPORTED_MODULE_1__.Guid.newGuid();
            exisitng.push(model);
        }
        _Helper_LocalStorageHelper__WEBPACK_IMPORTED_MODULE_0__.LSHelper.setWithExpiry(LSCONNECTIONS_KEY, exisitng);
    }
    Remove(id) {
        let exisitng = this.GetAll();
        let newArr = [];
        if (!exisitng)
            exisitng = [];
        if (id && id !== _Helper_Model__WEBPACK_IMPORTED_MODULE_1__.Guid.Empty) {
            newArr = exisitng.filter(e => e.Id !== id);
        }
        else {
            newArr = exisitng;
        }
        _Helper_LocalStorageHelper__WEBPACK_IMPORTED_MODULE_0__.LSHelper.setWithExpiry(LSCONNECTIONS_KEY, newArr);
    }
}
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["reactvendor","xlsxvendor","vendors-node_modules_fluentui_font-icons-mdl2_lib_index_js-node_modules_fluentui_react_lib_co-fa9d15"], () => (__webpack_require__("./app.tsx")))
/******/ 	__webpack_exports__ = __webpack_require__.O(__webpack_exports__);
/******/ 	
/******/ })()
;
//# sourceMappingURL=main.c902999cbefc2815ec64.js.map