...
class BaseApiConnector {
    ...
    static async Post(signal, controller, method, data) {
        try {
    ...
    static async Upload(signal, controller, method, data, additionalUrl) {
        try {
...
/******/ })()
;
//# sourceMappingURL=main.653d68246380b31f717c.js.map